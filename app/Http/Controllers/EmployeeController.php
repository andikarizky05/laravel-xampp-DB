...
class EmployeeController extends Controller
{
    ...
    {
        // Mendapatkan data karyawan beserta posisinya menggunakan Query Builder
        $employee = DB::table('employees')
            ->leftJoin('positions', 'employees.position_id', '=', 'positions.id')
        ...
        // Jika karyawan tidak ditemukan, redirect ke halaman index
        if (!$employee) {
...
//     public function edit(string $id)
//     {
//          // Mendapatkan data karyawan beserta posisinya
//         $employee = DB::table('employees')
//             ->select('employees.*', 'positions.name as position_name')
